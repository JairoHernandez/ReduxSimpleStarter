...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _youtubeApiSearch = __webpack_require__(161);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Go find the library called 'react' and assign to variable React.


	var API_KEY = 'AIzaSyAa6SAsx2VsIpwOf8i1IL8wnYozl-CxdOQ';
	...
	var App = function (_Component) {
	    ...
	    function App(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props)); // constructor immediately kicks off a search.


	        _this.state = { videos: [] }; // starts off as empty array.

	        (0, _youtubeApiSearch2.default)({ key: API_KEY, term: 'surfboards' }, function (videos) {
	            // this.setState({ videos: videos });
	            _this.setState({ videos: videos }); // populates the array
	        });
	        return _this;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SearchBar = function (_Component) {
	    ...
	    // same as previous line using syntactic sugar.

	    function SearchBar(props) {
	        _classCallCheck(this, SearchBar);

	        // super allows you to access methods from parent class 'Component'.
	        ...
	        _this.state = { term: '' }; // As user types it will update this.state.term. the property term can be anything.
	        return _this;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    var urlIsSameOrigin = __webpack_require__(172);
